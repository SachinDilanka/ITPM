...
export const knowVerseColors = {
  ...
  accent: {
    ...
    green: '#4caf50',
    orange: '#ff9800',
    red: '#f44336', // errors / destructive (when not using brand delete palette)
    yellow: '#ffc107',
  },
  ...
  semantic: {
    ...
    error: {
      main: '#9333ea', // Brand-consistent (not red)
      light: '#ec4899',
      gradient: 'linear-gradient(45deg, #9333ea, #ec4899)',
...
/**
 * Full MUI theme (use with ThemeProvider).
 * Uses createTheme() so palette, breakpoints, and component defaults resolve correctly.
 */
export function createKnowVerseTheme() {
  return createTheme({
    palette: {
      mode: 'dark',
      primary: {
